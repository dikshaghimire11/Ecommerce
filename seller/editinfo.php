...
$customer_id=$_SESSION['sellerid'];
$selectseller="SELECT * from seller where id=$customer_id";
...
function Validate() {
    ...
    <?php
        if(isset($_POST['ok'])){
            ...
            $dml = "UPDATE seller set name='$name',email='$email',address='$address',contact_number='$contact_number' where id=$customer_id";
